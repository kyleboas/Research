...
def main():
    parser = argparse.ArgumentParser(description="Optimize ingest policy from recent source-lag and volume observations")
    ...
    parser.add_argument("--min-improvement", type=float, default=DEFAULT_MIN_IMPROVEMENT, help="Minimum score improvement required before applying")
